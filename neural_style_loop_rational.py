...
POOLING = 'max'
RANGE_SIGMA = [100, 500, 1000, 2000, 5000, 10000, 15000, 20000, 30000]
RANGE_SW = [1e18, 5e18, 1e19, 5e19, 1e20, 5e21, 1e22]  # [1e-10, 1e-15, 1e-20, 1e-25, 1e-30, 1e-35]
# CONTENT_IMAGES = sorted(os.listdir("examples/content"))
STYLE_IMAGES = sorted(os.listdir("examples/style"))
KERNEL = 5
alpha = 2
name_kernel = "rational_2"
# TARGET_WIDTH = 256
